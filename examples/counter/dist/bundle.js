...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tinyflux = __webpack_require__(2);

	var _tinyflux2 = _interopRequireDefault(_tinyflux);
	...
	var CounterComponent = (function (_TinyFlux$Component) {
		_inherits(CounterComponent, _TinyFlux$Component);

		function CounterComponent(props) {
			_classCallCheck(this, CounterComponent);

			_get(Object.getPrototypeOf(CounterComponent.prototype), "constructor", this).call(this, props);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./src/tinyflux.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToDoStore = (function (_TinyFlux$Store) {
		_inherits(ToDoStore, _TinyFlux$Store);
